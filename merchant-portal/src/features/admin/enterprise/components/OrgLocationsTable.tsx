...
import type { OrgLocationRow } from "../../../core/finance/orgConsolidationApi";

interface OrgLocationsTableProps {
...
export function OrgLocationsTable({
  locations,
  formatCents,
}: OrgLocationsTableProps) {
