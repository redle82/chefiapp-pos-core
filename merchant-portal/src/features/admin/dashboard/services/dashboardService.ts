...
export async function getOverview(
  ...
  try {
    ...
    const pendingAmountCents = openOrders.reduce(
    ...
    const avgAmountPerBill =
      totalBills > 0 ? totalRevenueEuros / totalBills : 0;
    const avgAmountPerSeat =
      seatsTotal > 0 ? totalRevenueEuros / seatsTotal : 0;
    ...
    return {
      ...
      general: {
        deletedProducts,
        deletedPayments,
        discounts: 0, // TODO: implement discount tracking
