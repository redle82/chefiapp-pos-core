...
export interface CoreTask {
  ...
  task_type: 'ATRASO_ITEM' | 'ACUMULO_BAR' | 'ENTREGA_PENDENTE' | 'ITEM_CRITICO' | 'PEDIDO_ESQUECIDO' | 'ESTOQUE_CRITICO' | 'RUPTURA_PREVISTA' | 'EQUIPAMENTO_CHECK';
...
export interface CoreTaskPack {
  ...
  operation_type: 'AMBULANTE' | 'BAR' | 'RESTAURANTE' | 'RESTAURANTE_GRANDE' | 'MULTIUNIDADE' | null;
  is_active: boolean;
  created_at: string;
  updated_at: string;
}
