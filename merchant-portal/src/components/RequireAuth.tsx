...
export function RequireAuth({ children }: { children: JSX.Element }) {
    ...
    if (loading) {
        ...
        return (
            <div style={{
                ...
                <span style={{ fontSize: '12px', letterSpacing: '1px', opacity: 0.8 }}>SOVEREIGN IDENTITY CHECK</span>
                <style>{`
    ...
    if (!session && !isDemo) {
        console.warn('🛡️ [AUTH] Access Denied: No session found. Redirecting to /login');
