...
import { CapabilityEngine, type Capability, type PlanType } from './CapabilityMatrix';
...
export const PlanProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const can = (capability: Capability) => CapabilityEngine.has(plan, capability);

    const requiredPlan = (capability: Capability) => CapabilityEngine.requiredPlanFor(capability);
    ...
    return (
        <PlanContext.Provider value={{ plan, loading, can, requiredPlan, upgradeTo }}>
            {children}
