...
const MOCK_PROFILE: GoogleBusinessProfile = {
    id: 'gmb_123456789',
    title: 'ChefIApp Bistro Demo',
    description: 'A modern bistro demonstrating the power of ChefIApp Sovereign OS.',
    category: 'Restaurant',
    address: {
...
export const GoogleBusinessMock = {
    ...
    connect: async (): Promise<GoogleBusinessProfile> => {
        console.log('[GoogleBusinessMock] 📡 Connecting to Google Business Profile...');
