...
// Configuration
const SUPABASE_URL = Deno.env.get('SUPABASE_URL') || 'https://qonfbtwsxeggxbkhqnxl.supabase.co';
...
async function runTest() {
    ...
    console.log(`📦 Created Inventory Item: ${invItemId} (Stock: ${initialStock})`);
    ...
    console.log(`🔍 Final Stock: ${finalItem.stock_quantity} (Expected: ${expectedStock})`);
