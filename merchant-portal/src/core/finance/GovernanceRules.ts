...
export const CANCEL_REASONS: ValidatedReason[] = [
  // 🏭 PRODUCTION (Kitchen Fault)
  {
    id: "prod_burn",
    category: "production",
    label: "Erro Cozinha (Queimado/Impróprio)",
  ...
  },
  {
    id: "cli_nopay",
    category: "client",
    label: "Cliente Saiu sem Pagar (Calote)",
    requiresManager: true,
    affectsStock: false,
  },
  ...
  // 💻 SYSTEM (Technical)
  {
    id: "sys_error",
    category: "system",
    label: "Erro Sistema / Duplicidade",
    requiresManager: true,
    affectsStock: true,
  },
  {
  ...
  // 🚨 FRAUD PREVENTION (Immune System)
  {
    ...
    label: "Suspeita de Fraude (Investigação)",
    requiresManager: true,
    affectsStock: false,
  },
];
...
export const requiresWitness = (amountCents: number): boolean => {
  return amountCents > 5000; // 50.00 in local currency
};
