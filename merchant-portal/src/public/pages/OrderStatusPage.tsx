...
export const OrderStatusPage: React.FC = () => {
    ...
    const colorClass = STATUS_COLORS[status.status] || 'bg-gray-100 text-gray-700';
        ...
        <div className="min-h-screen bg-neutral-50 p-6">
            <div className="max-w-md mx-auto">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-neutral-900 mb-2">Status do Pedido</h1>
                ...
                >
                    <div className="text-center">
                        ...
                        <div className={`inline-block px-4 py-2 rounded-full font-semibold mb-4 ${colorClass}`}>
                            {status.message}
                        </div>
                        <p className="text-sm text-neutral-500">Pedido #{orderId?.slice(0, 8)}</p>
                    </div>
                </motion.div>

                {/* Progress Steps */}
                <div className="bg-white rounded-xl shadow-lg p-6">
                    <h2 className="font-semibold text-neutral-900 mb-4">Etapas do Pedido</h2>
                    <div className="space-y-4">
                        {[
                            ...
                            const isCompleted = ['new', 'OPEN', 'IN_PREP', 'READY', 'PAID'].indexOf(status.status) > 
