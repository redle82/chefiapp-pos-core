...
import { MessageSquare, X, Send, AlertTriangle, Lightbulb, CheckCircle } from 'lucide-react';
import { useLocation } from 'react-router-dom';
import { useSupabaseAuth } from '../../core/auth/useSupabaseAuth';
import { useTenant } from '../../core/tenant/TenantContext'; // Correct path to TenantContext
            ...
            <div className="beta-feedback-modal">
                ...
                {success ? (
                    <div className="beta-feedback-success">
                        ...
                        <p className="text-sm text-gray-500">Obrigado por nos ajudar a melhorar.</p>
                    </div>
                ) : (
                    <form onSubmit={handleSubmit} className="beta-feedback-form">
                        ...
                        <div className="beta-form-group">
                            ...
                            <textarea
                                ...
                                placeholder={type === 'bug' ? "O que você estava fazendo e o que aconteceu?" : "Qual sua ideia ou sugestão?"}
                                rows={4}
                                required
