      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <div className="text-xs text-zinc-500 font-bold font-mono mt-1.5 flex items-center gap-1.5 uppercase tracking-wide">
            <span className={status === 'preparing' ? 'text-amber-500 animate-pulse' : ''}>⏱ 12:45</span>
      ...
      <div className="pt-3 border-t border-neutral-800 mt-auto">
        <div className="flex justify-between items-center mb-3">
          <div className="flex flex-col">
            <span className="text-[10px] uppercase text-neutral-500 font-bold tracking-wider">Total</span>
          ...
          {dataStatus === 'failed' ? (
            ...
            <>
              ...
              {status === 'preparing' && onAction && (
                <button
                  onClick={(e) => { e.stopPropagation(); onAction('ready'); }}
