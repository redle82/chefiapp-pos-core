...
export type TextColor =
    | 'primary' | 'secondary' | 'tertiary' | 'quaternary' | 'inverse' // Text keys
    | 'action' | 'warning' | 'success' | 'destructive' | 'info' | 'error'; // Semantic keys (mapped)
...
export const Text: React.FC<TextProps> = ({
    ...
    const baseStyle: React.CSSProperties = {
        ...
        textAlign: align,
        lineHeight: size === '2xl' || size === '3xl' || size === '4xl' ? typography.leading.none : typography.leading.normal,
        // Truncation
        ...(truncate && {
            whiteSpace: 'nowrap',
            overflow: 'hidden',
