...
export const ShiftForecastWidget: React.FC<ShiftForecastWidgetProps> = ({ pressure, prediction }) => {
    ...
    return (
        <Card surface="layer2" padding="none" style={{
            backgroundColor: bg,
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
                    <Text size="xs" weight="bold" style={{ color: accent, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                        {label}
                    </Text>
                    <div style={{ marginTop: 4 }}>
                        <Text size="xs" color="tertiary">
                            Index: {pressure.pressureIndex} (Pedidos: {pressure.ordersLastWindow})
                        </Text>
                    </div>
                </div>
            ...
            <div style={{ marginTop: 8, paddingTop: 8, borderTop: `1px solid ${colors.border.subtle}` }}>
