...
export function MiniKDSMinimal({
  restaurantId,
  maxHeight = "400px",
}: MiniKDSMinimalProps) {
      ...
      >
        ...
        <span
          style={{
            ...
            color: realtimeStatus === "SUBSCRIBED" ? VPC.accent : "#f87171",
          }}
        >
            ...
            {orders.map((order) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <strong style={{ fontSize: VPC.fontSizeBase }}>
                    ...
                    >
                      ...
                      <span
                        style={{
                          color: orderStatus.borderColor,
                          fontSize: 14,
                          fontWeight: orderStatus.state === "delay" ? 700 : 400,
                        }}
                      >
