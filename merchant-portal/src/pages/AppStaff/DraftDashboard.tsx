  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: Spacing.sm }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <span style={{ fontSize: 9, opacity: 0.5, letterSpacing: 0.5 }}>
              GOLDMONKEY SECURITY LAYER
            </span>
          </div>
        </div>
      ...
      <div style={{ width: "100%", maxWidth: "600px", textAlign: "center" }}>
        ...
        >
          Seu núcleo operacional foi criado com sucesso, mas o sistema permanece
          em modo de proteção até confirmarmos que este restaurante existe no
          mundo real.
        </p>
        ...
        >
          ...
          >
            Para liberar vendas, cardápio e pagamentos, conecte seu
            estabelecimento ao mundo real. Leva menos de 1 minuto.
          </p>
