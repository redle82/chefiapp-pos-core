...
const META_TITLE =
  "TPV para Restaurantes | Sistema Operacional — ChefIApp™ OS";
    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
        ...
        <article className="max-w-3xl mx-auto px-6 py-12 md:py-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            TPV para restaurantes: o que os grandes players fazem e o que
            podemos vender hoje
          </h1>
          ...
          <section className="prose prose-invert prose-amber max-w-none mb-14">
            ...
            <p className="text-neutral-300 leading-relaxed mb-4">
              ...
              operação de vendas: onde se registam pedidos, se associam a mesas
              ou clientes, se aplicam descontos e se processam pagamentos. Em
            ...
            <p className="text-neutral-300 leading-relaxed mb-4">
              Os líderes do mercado oferecem TPV físico e/ou em tablet, gestão
              de mesas, pedidos em tempo real, integração com cozinha (KDS),
              pagamentos integrados, relatórios e, em muitos casos, reservas e
              delivery. O padrão é: um único ecossistema para sala, cozinha, bar
              e caixa, com dados em tempo real e menos “colagem” de sistemas.
            </p>
            <p className="text-neutral-300 leading-relaxed mb-4">
              O ChefIApp™ OS segue essa mesma ideia: um sistema operacional para
              o restaurante, não um POS fiscal isolado. O que descrevemos abaixo
              é o que está implementado e em uso hoje.
            </p>
            ...
            <p className="text-neutral-300 leading-relaxed mb-4">
              Tudo o que se segue existe no produto e no código. Nada é
              roadmap nem “em breve” disfarçado de realidade.
            </p>
            <ul className="list-disc pl-6 text-neutral-300 space-y-2 mb-6">
              ...
              <li>
                <strong>Mapa de mesas</strong>: mesas do Core, criação de
                pedido por mesa, navegação entre mesas, pedidos e reservas.
              </li>
              <li>
                <strong>Pagamentos</strong>: modal de pagamento por pedido,
                suporte a pagamento parcial (split bill), integração com motor
                de pagamento. Emissão fiscal quando o total está pago (conforme
                configuração).
              </li>
              <li>
                <strong>Caixa e turnos</strong>: abertura e fecho de caixa (com
                permissão de gerente), turnos ligados à sessão. Impossível
                fechar caixa com pedidos em aberto.
              </li>
              <li>
                <strong>Menu dinâmico</strong>: menu por restaurante e modo
                (TPV), categorias e produtos, usado no TPV e no resto do sistema.
              </li>
              <li>
                <strong>KDS (Cozinha)</strong>: pedidos em tempo real na
                cozinha, estados (em preparação, pronto), integrado ao mesmo
                fluxo do TPV.
              </li>
              <li>
              ...
              <li>
                <strong>Multi-idioma</strong>: interface e landing em
            ...
            <p className="text-neutral-400 text-sm italic mb-8">
              ...
              o TPV operacional e o POS fiscal coexistem.
            </p>
            ...
            <p className="text-neutral-300 leading-relaxed mb-4">
              ...
              restaurante e suporte por WhatsApp. 14 dias grátis, sem cartão,
              sem contrato. Depois do trial, preço único por mês, sem módulos
              escondidos.
            </p>
          </section>
