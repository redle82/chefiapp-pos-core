 ...
 *
 * Única landing canónica do ChefIApp™ OS. Route: /landing-v2, /v2
...
function LandingV2Content() {
  ...
  useEffect(() => {
    ...
    for (const hreflang of ["x-default", "pt", "en", "es"] as const) {
      ...
      link.setAttribute("href", hreflang === "x-default" ? defaultHref : `${baseUrl}?lang=${hreflang}`);
    ...
    return () => {
      ...
      if (prevMeta && prevContent !== null) prevMeta.setAttribute("content", prevContent);
      if (prevLang !== null) document.documentElement.setAttribute("lang", prevLang);
...
export const LandingV2Page = () => <LandingV2Content />;
