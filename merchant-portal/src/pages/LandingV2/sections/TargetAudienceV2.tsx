 ...
 * Copy via useLandingLocale + getTargetAudience (i18n/landingV2Copy).
 */
import { getTargetAudience } from "../i18n/landingV2Copy";
...
export const TargetAudienceV2 = () => {
  ...
  const ta = getTargetAudience(locale);
