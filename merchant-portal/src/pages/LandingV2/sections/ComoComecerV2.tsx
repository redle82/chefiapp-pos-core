 ...
 *
 * Conversion-critical section. Shows the onboarding is fast and friction-free.
 * Horizontal 3-step visual with connectors on desktop, stacked on mobile.
 */
      ...
      <div className="max-w-5xl mx-auto px-6 relative">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <p className="text-neutral-400 text-lg max-w-2xl mx-auto leading-relaxed">
            Sem técnico. Sem instalação. Sem espera.
          </p>
        </div>
            ...
            {STEPS.map((step) => (
              <div key={step.num} className="relative text-center group">
                ...
                <div className="relative z-10 mx-auto w-24 h-24 rounded-2xl bg-[#0a0a0a] border-2 border-amber-500/30 flex flex-col items-center justify-center mb-6 group-hover:border-amber-500 transition-colors">
                  <div className="text-amber-500 mb-1">{step.icon}</div>
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-xs text-neutral-600 mt-4">
            Registo em 2 minutos. Sem cartão de crédito.
          </p>
        </div>
      </div>
    </section>
