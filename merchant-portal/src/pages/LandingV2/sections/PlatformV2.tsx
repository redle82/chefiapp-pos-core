 ...
 * Copy via useLandingLocale + getPlatform (i18n/landingV2Copy).
 */
import { getPlatform } from "../i18n/landingV2Copy";
...
const PLATFORM_ICONS = [
  ...
  <svg key="8" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 9.75c0 .746-.092 1.47-.264 2.165m-2.019 5.338A9.009 9.009 0 0015 18a9.009 9.009 0 00-3.717-2.838M12 10.5c2.998 0 5.74 1.1 7.843 2.918" /></svg>,
