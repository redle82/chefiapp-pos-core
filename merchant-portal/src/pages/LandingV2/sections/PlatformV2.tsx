/**
 * Platform V2 — "Componentes do Sistema Operacional"
 *
 * Modular cards with proper SVG icons. Grouped visually.
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 9.75c0 .746-.092 1.47-.264 2.165m-2.019 5.338A9.009 9.009 0 0015 18a9.009 9.009 0 00-3.717-2.838M12 10.5c2.998 0 5.74 1.1 7.843 2.918"
        />
      </svg>
    ),
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <p className="text-neutral-400 text-lg max-w-2xl mx-auto leading-relaxed">
            O ChefIApp™ OS coordena todas as áreas da operação — sem módulos
            separados, sem integrações externas, sem surpresas.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {MODULES.map((mod) => (
            <div
              key={mod.title}
              className="group relative p-6 rounded-xl border border-white/5 bg-neutral-900/40 hover:border-amber-500/20 hover:bg-neutral-900/70 transition-all duration-300"
            >
              <div className="w-10 h-10 rounded-lg bg-amber-500/10 flex items-center justify-center text-amber-500 mb-4 group-hover:bg-amber-500/20 transition-colors">
                {mod.icon}
              </div>
        ...
        <p className="text-center text-neutral-600 text-sm mt-12">
          Todos os componentes incluídos. Um único sistema operacional. Zero
          surpresas.
        </p>
      </div>
    </section>
