...
export const DashboardZero = () => {
    ...
    useEffect(() => {
        ...
        // 🛡️ ACTIVATION GUARD
        // Se o usuário ainda não definiu o modo de operação, redireciona para o fluxo de ativação.
        // Exceto se for um desenvolvedor bypassando.
        const opMode = getTabIsolated('chefiapp_operation_mode');
        const urlParams = new URLSearchParams(window.location.search);

        if (!opMode && !urlParams.get('skip_activation')) {
            console.log('[Dashboard] 🛑 Activation Guard: Operation Mode undefined. Redirecting to Activation Wizard.');
