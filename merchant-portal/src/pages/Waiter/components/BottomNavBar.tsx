...
export function BottomNavBar({ callsCount = 0, ordersCount = 0, chatUnread = 0 }: BottomNavBarProps) {
  ...
  const navItems = [
    { 
      ...
      label: 'Mapa', 
      path: '/app/waiter',
      active: isActive('/app/waiter') && !isActive('/app/waiter/calls') && !isActive('/app/waiter/orders') && !isActive('/app/waiter/chat') && !isActive('/app/waiter/profile')
    },
    { 
      icon: '🔔', 
      label: 'Chamados', 
