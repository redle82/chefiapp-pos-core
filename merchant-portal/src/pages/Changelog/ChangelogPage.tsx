...
const CHANGELOG_ENTRIES: { date: string; title: string; description: string }[] = [
  {
    date: "Fev 2026",
    title: "Blog TPV para restaurantes",
    description: "Página pública /blog e /blog/tpv-restaurantes com artigo honesto sobre TPV, POS e o que o ChefIApp oferece hoje. SEO e JSON-LD Article.",
  },
  {
    date: "Fev 2026",
    title: "Landing V2 em três idiomas",
    description: "Landing com locale pt, en, es (query ?lang=). Bandeira Brasil + setor de idioma no navbar. Copy completa em português, inglês e espanhol.",
  },
  {
    date: "Fev 2026",
  ...
  },
  {
    ...
    description: "Pagamento parcial por pedido (split bill). Modal de pagamento com suporte a múltiplos pagamentos até cobrir o total.",
  },
  {
    date: "2025",
    title: "TPV — mapa de mesas e turnos",
    description: "Criação de pedidos por mesa, navegação mesas/pedidos. Abertura e fecho de caixa (gerente). Turnos ligados à sessão; impossível fechar caixa com pedidos em aberto.",
  },
  {
    date: "2025",
    title: "KDS integrado ao TPV",
    description: "Pedidos em tempo real na cozinha/bar. Estados em preparação e pronto. Indicadores de atraso e tarefas operacionais.",
  },
  {
    date: "2025",
    title: "Menu Builder e catálogo",
    description: "Produtos e categorias por restaurante. Ligação ao TPV, KDS e página pública do restaurante.",
  },
  {
    date: "2025",
    title: "Staff App (mini-TPV e turnos)",
    description: "App de equipa com visibilidade de pedidos e tarefas. Mini-TPV em contexto (ex.: esplanada). Turnos e check-in.",
  },
  {
    date: "2025",
    title: "Reservas e mapa de mesas",
    description: "Gestão de reservas e mapa de mesas no mesmo sistema que o TPV.",
  },
  {
    date: "2025",
    title: "Página pública do restaurante",
    description: "Menu e pedidos online por restaurante (/public/:slug). Mesmos dados do catálogo e do TPV.",
  },
];
    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 md:py-16">
        ...
        <p className="text-neutral-400 text-lg mb-12">
          Actualizações reais do ChefIApp™ OS. Só o que está em produção — sem roadmap nem promessas.
        </p>
