...
import { readAllPacks, readActivatedPacks, readPacksByContext } from '../../core-boundary/readers/TaskPackReader';
import { activatePack, deactivatePack } from '../../core-boundary/writers/TaskPackWriter';
  ...
  return (
    <div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: '11px', color: '#9ca3af' }}>
                      ...
                      {pack.min_team_size && `Equipe: ${pack.min_team_size}-${pack.max_team_size || '∞'} • `}
                      {pack.min_tables !== null && `Mesas: ${pack.min_tables}-${pack.max_tables || '∞'}`}
                    </div>
                  </div>
                  <button
      ...
      <div style={{ 
        ...
        <ul style={{ marginTop: '8px', paddingLeft: '20px', fontSize: '14px', color: '#1e40af' }}>
          <li><strong>{impact.packs}</strong> packs ativados</li>
          <li><strong>{impact.tasksPerShift}</strong> tarefas por turno (estimado)</li>
