...
import { readZones, readTables } from '../../core-boundary/readers/MapReader';
import { upsertZone, upsertTable, deactivateZone, deactivateTable } from '../../core-boundary/writers/MapWriter';
import type { CoreRestaurantZone, CoreRestaurantTable } from '../../core-boundary/docker-core/types';
...
export function MapBuilderMinimal({ restaurantId }: MapBuilderMinimalProps) {
  ...
  const handleCreateTable = async () => {
    ...
    try {
      const zone = zones.find(z => z.id === newTableZone);
      await upsertTable({
        restaurant_id: restaurantId,
