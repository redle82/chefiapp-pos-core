...
export function ManagerDashboardPage() {
  ...
  const alerts = [
    { id: '1', severity: 'critical' as const, title: 'Estoque crítico: Tomate (0kg)', action: 'Comprar agora' },
    { id: '2', severity: 'warning' as const, title: 'KDS atrasado: 3 itens', action: 'Ver KDS' },
  ];
  const bottlenecks = {
    ...
    <div style={{ paddingBottom: '80px' }}>
      ...
      <div style={{ padding: '16px' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '18px', fontWeight: 600, color: getStatusColor(status) }}>
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '14px', marginBottom: '8px' }}>
              KDS: {bottlenecks.kds.station} ({bottlenecks.kds.items} itens {bottlenecks.kds.status === 'delayed' ? 'atrasados' : ''})
            </div>
            <div style={{ fontSize: '14px', marginBottom: '8px' }}>
              Estoque: {bottlenecks.stock.items} item{bottlenecks.stock.items > 1 ? 's' : ''} {bottlenecks.stock.status === 'critical' ? 'crítico' : ''}
            </div>
            <div style={{ fontSize: '14px' }}>
              Staff: Cobertura {bottlenecks.staff.coverage === 'adequate' ? 'adequada' : 'insuficiente'}
            </div>
          </div>
        </div>
