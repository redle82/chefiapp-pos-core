...
export function deriveLifecycleState(params: LifecycleStateInput): RestaurantLifecycleState {
  if (stryMutAct_9fa48("33")) {
    ...
    if (stryMutAct_9fa48("35") ? false : stryMutAct_9fa48("34") ? true : (stryCov_9fa48("34", "35"), hasOrganization)) {
      if (stryMutAct_9fa48("36")) {
        {}
      } else {
        stryCov_9fa48("36");
        return stryMutAct_9fa48("37") ? "" : (stryCov_9fa48("37"), "READY_TO_OPERATE");
      }
    }
    if (stryMutAct_9fa48("39") ? false : stryMutAct_9fa48("38") ? true : (stryCov_9fa48("38", "39"), isAuthenticated)) {
      if (stryMutAct_9fa48("40")) {
        {}
      } else {
        stryCov_9fa48("40");
        if (stryMutAct_9fa48("43") ? pathname === "/bootstrap" && pathname === "/setup/restaurant-minimal" : stryMutAct_9fa48("42") ? false : stryMutAct_9fa48("41") ? true : (stryCov_9fa48("41", "42", "43"), (stryMutAct_9fa48("45") ? pathname !== "/bootstrap" : stryMutAct_9fa48("44") ? false : (stryCov_9fa48("44", "45"), pathname === (stryMutAct_9fa48("46") ? "" : (stryCov_9fa48("46"), "/bootstrap")))) || (stryMutAct_9fa48("48") ? pathname !== "/setup/restaurant-minimal" : stryMutAct_9fa48("47") ? false : (stryCov_9fa48("47", "48"), pathname === (stryMutAct_9fa48("49") ? "" : (stryCov_9fa48("49"), "/setup/restaurant-minimal")))))) {
          if (stryMutAct_9fa48("50")) {
            {}
          } else {
            stryCov_9fa48("50");
            return stryMutAct_9fa48("51") ? "" : (stryCov_9fa48("51"), "BOOTSTRAP_IN_PROGRESS");
          }
        }
        return stryMutAct_9fa48("52") ? "" : (stryCov_9fa48("52"), "BOOTSTRAP_REQUIRED");
      }
    }
    return stryMutAct_9fa48("53") ? "" : (stryCov_9fa48("53"), "VISITOR");
  }
}
