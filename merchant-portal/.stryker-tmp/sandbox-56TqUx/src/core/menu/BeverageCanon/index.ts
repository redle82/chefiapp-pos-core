...
export function getBeverageCanon(countryCode: string): CountryBeverageCanon {
    ...
    switch (normalized) {
        ...
        // Future: BR, PT, FR, etc.
        default:
            console.warn(`[BeverageCanon] No specific canon for ${countryCode}, using default`);
...
export type { CountryBeverageCanon, BeverageCanonItem, BeverageCanonCategory } from './types';
