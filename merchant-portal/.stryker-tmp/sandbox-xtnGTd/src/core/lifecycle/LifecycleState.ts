...
export function deriveLifecycleState(params: LifecycleStateInput): RestaurantLifecycleState {
  if (stryMutAct_9fa48("167")) {
    ...
    if (stryMutAct_9fa48("169") ? false : stryMutAct_9fa48("168") ? true : (stryCov_9fa48("168", "169"), hasOrganization)) {
      if (stryMutAct_9fa48("170")) {
        {}
      } else {
        stryCov_9fa48("170");
        return stryMutAct_9fa48("171") ? "" : (stryCov_9fa48("171"), "READY_TO_OPERATE");
      }
    }
    if (stryMutAct_9fa48("173") ? false : stryMutAct_9fa48("172") ? true : (stryCov_9fa48("172", "173"), isAuthenticated)) {
      if (stryMutAct_9fa48("174")) {
        {}
      } else {
        stryCov_9fa48("174");
        if (stryMutAct_9fa48("177") ? pathname === "/bootstrap" && pathname === "/setup/restaurant-minimal" : stryMutAct_9fa48("176") ? false : stryMutAct_9fa48("175") ? true : (stryCov_9fa48("175", "176", "177"), (stryMutAct_9fa48("179") ? pathname !== "/bootstrap" : stryMutAct_9fa48("178") ? false : (stryCov_9fa48("178", "179"), pathname === (stryMutAct_9fa48("180") ? "" : (stryCov_9fa48("180"), "/bootstrap")))) || (stryMutAct_9fa48("182") ? pathname !== "/setup/restaurant-minimal" : stryMutAct_9fa48("181") ? false : (stryCov_9fa48("181", "182"), pathname === (stryMutAct_9fa48("183") ? "" : (stryCov_9fa48("183"), "/setup/restaurant-minimal")))))) {
          if (stryMutAct_9fa48("184")) {
            {}
          } else {
            stryCov_9fa48("184");
            return stryMutAct_9fa48("185") ? "" : (stryCov_9fa48("185"), "BOOTSTRAP_IN_PROGRESS");
          }
        }
        return stryMutAct_9fa48("186") ? "" : (stryCov_9fa48("186"), "BOOTSTRAP_REQUIRED");
      }
    }
    return stryMutAct_9fa48("187") ? "" : (stryCov_9fa48("187"), "VISITOR");
  }
}
...
export function isPathAllowedForState(pathname: string, state: RestaurantLifecycleState): boolean {
  if (stryMutAct_9fa48("190") ? state !== "READY_TO_OPERATE" : stryMutAct_9fa48("189") ? false : stryMutAct_9fa48("188") ? true : (stryCov_9fa48("188", "189", "190"), state === (stryMutAct_9fa48("191") ? "" : (stryCov_9fa48("191"), "READY_TO_OPERATE")))) {
    if (stryMutAct_9fa48("192")) {
      {}
    } else {
      stryCov_9fa48("192");
      return stryMutAct_9fa48("193") ? false : (stryCov_9fa48("193"), true);
    }
  }
