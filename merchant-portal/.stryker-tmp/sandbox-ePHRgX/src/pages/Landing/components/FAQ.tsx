...
const CONTACT_EMAIL =
  (typeof import.meta !== "undefined" &&
    (import.meta as unknown as { env?: { VITE_CONTACT_EMAIL?: string } })?.env
      ?.VITE_CONTACT_EMAIL) ||
...
export const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      a: `Teste primeiro. Se fizer sentido, ${CANONICAL_MONTHLY_PRICE_LABEL} após período de teste.`,
    },
    {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="bg-neutral-900/50 p-6 border border-white/5 hover:border-amber-500/30 transition-colors rounded-lg group"
            >
              <h3 className="text-lg font-bold mb-3 text-white group-hover:text-amber-500 transition-colors">
                {faq.q}
              </h3>
        ...
        <div className="text-center mt-16">
          <p className="text-neutral-500 mb-6 font-mono text-xs uppercase tracking-wider">
            Ainda tem dúvidas?
          </p>
          <a
