 ...
 *
 * @internal DEV_ONLY — must never be imported in production screens.
 *
 * This component is a developer tool for switching roles dynamically during
 * local development and QA. It is superseded by {@link RoleSelector} for
 * end-user role selection and should remain in this file only.
 *
 * Runtime guard: returns null when __DEV__ is false (i.e. in production).
 * Build-time guard: do not import this component outside of __DEV__ branches.
 */

// Module-level guard: in production builds Metro/Hermes may tree-shake this
// away since the component always returns null. The explicit check below also
// makes it safe if inadvertently imported.
if (!__DEV__) {
  // eslint-disable-next-line no-console
  console.warn(
    "[RoleSelectorDevPanel] Imported in a non-DEV build — this file should only be used during development.",
  );
}
...
export function RoleSelectorDevPanel() {
  ...
  const handleOperationTypeChange = (type: OperationType) => {
    ...
    resetShift();
    showFeedback(
      `Operação alterada para: ${OPERATION_TYPE_LABELS[type].label}`,
    );
  };
  ...
  const handleMaturityChange = (maturity: Maturity) => {
    ...
    showFeedback(
      `Maturidade definida como: ${MATURITY_LABELS[maturity].label}`,
    );
  };
            ...
            <ScrollView style={styles.scrollContent}>
                ...
                <View style={styles.currentState}>
                  ...
                  >
                    <View>
                      ...
                      <Text style={styles.currentStateSubtext}>
                        {
                          OPERATION_TYPE_LABELS[
                            operationalContext.operationType
                          ].emoji
                        }{" "}
                      ...
                      <Text style={styles.currentStateSubtext}>
                        Maturidade:{" "}
                        {MATURITY_LABELS[operationalContext.maturity].label}
                      </Text>
                    </View>
                    <View>
                      <TouchableOpacity
                ...
                <View style={styles.optionsRow}>
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.helpText}>
                      Use isto para testar o "Shift Lock". Com o turno ativo,
                      você não deve conseguir mudar o Papel ou Contexto.
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.section}>
                ...
                <View
                  style={[
                    styles.optionsGrid,
                    shiftState === "active" && styles.disabledSection,
                  ]}
                >
                  {allRoles.map((role) => {
                ...
                {shiftState === "active" && (
                  <Text style={styles.lockWarning}>
                    🔒 Alteração bloqueada durante turno
                  </Text>
                )}
              </View>
              ...
              <View style={styles.section}>
                ...
                <View style={styles.infoGrid}>
                  ...
                  <View style={styles.infoItem}>
                    ...
                    <Text style={styles.infoValue}>
                      {roleConfig.taskCategories.join(", ") || "Nenhuma"}
                    </Text>
                  </View>
                </View>
              </View>
