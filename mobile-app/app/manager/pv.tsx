...
export default function AppStaffPvScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>PV Mobile</Text>
      ...
      <View style={styles.actionsColumn}>
        ...
        >
          <Text style={styles.primaryBtnText}>Abrir pedidos (TPV)</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={styles.secondaryBtnText}>Abrir cozinha</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
