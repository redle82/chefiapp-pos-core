-- Migration: 034_fix_atomic_rpc_signature.sql
-- Purpose: Fix the "Database Boot Failed" error by forcefully recreating the RPC
-- with the exact signature expected by the Frontend.
-- We ensure p_team_size is TEXT to match '1-5' | '6-15' values.
