/**
 * LEGACY-SKIP: OrderEngineOffline e core/queue/db foram removidos.
 * Arquitetura atual: Docker Core, TPV/KDS, fluxos reais validados por E2E.
 * Mantido em legacy-skip para referência; não executado pelo Jest.
 *
 * Original: tests/unit/offline/OrderEngineOffline.test.ts
 */
...
import type {
  Order,
  OrderInput,
} from "../../../../merchant-portal/src/core/tpv/OrderEngine";
import { OrderEngine } from "../../../../merchant-portal/src/core/tpv/OrderEngine";
import {
  checkOrderSynced,
  createOrderOffline,
} from "../../../../merchant-portal/src/core/tpv/OrderEngineOffline";
