...
describe('ActivationMetrics', () => {
    ...
    describe('aggregateActivationMetrics', () => {
        ...
        it('should count panel opens', () => {
            const events: ActivationEvent[] = [
                { name: 'activation.panel_opened', ts: Date.now(), payload: { variant: 'full' } },
                { name: 'activation.panel_opened', ts: Date.now(), payload: { variant: 'compact' } },
            ];
        ...
        it('should count recommendation views', () => {
            const events: ActivationEvent[] = [
                { name: 'activation.recommendation_viewed', ts: Date.now(), payload: { recommendationId: 'rec-1', impact: 'high' } },
                { name: 'activation.recommendation_viewed', ts: Date.now(), payload: { recommendationId: 'rec-2', impact: 'medium' } },
                { name: 'activation.recommendation_viewed', ts: Date.now(), payload: { recommendationId: 'rec-3', impact: 'low' } },
            ];
        ...
        it('should count recommendation clicks', () => {
            const events: ActivationEvent[] = [
                { name: 'activation.recommendation_clicked', ts: Date.now(), payload: { recommendationId: 'rec-1', impact: 'high' } },
                { name: 'activation.recommendation_clicked', ts: Date.now(), payload: { recommendationId: 'rec-2', impact: 'medium' } },
            ];
        ...
        it('should count dismisses', () => {
            const events: ActivationEvent[] = [
                { name: 'activation.recommendation_dismissed', ts: Date.now(), payload: { recommendationId: 'rec-1', impact: 'high' } },
            ];
        ...
        it('should break down by impact level', () => {
            const events: ActivationEvent[] = [
                { name: 'activation.recommendation_viewed', ts: Date.now(), payload: { recommendationId: 'rec-1', impact: 'high' } },
                { name: 'activation.recommendation_viewed', ts: Date.now(), payload: { recommendationId: 'rec-2', impact: 'high' } },
                { name: 'activation.recommendation_viewed', ts: Date.now(), payload: { recommendationId: 'rec-3', impact: 'medium' } },
                { name: 'activation.recommendation_clicked', ts: Date.now(), payload: { recommendationId: 'rec-1', impact: 'high' } },
            ];
        ...
        it('should track top clicked recommendations', () => {
            const events: ActivationEvent[] = [
                ...
                { name: 'activation.recommendation_clicked', ts: Date.now(), payload: { recommendationId: 'rec-1', impact: 'high' } },
                { name: 'activation.recommendation_clicked', ts: Date.now(), payload: { recommendationId: 'rec-2', impact: 'medium' } },
                { name: 'activation.recommendation_clicked', ts: Date.now(), payload: { recommendationId: 'rec-3', impact: 'low' } },
            ];
    ...
    describe('getActivationMetricsLastDays', () => {
        it('should get metrics for last N days', () => {
            const now = Date.now();
            const events: ActivationEvent[] = [
                { name: 'activation.panel_opened', ts: now - (2 * 24 * 60 * 60 * 1000), payload: {} },
                { name: 'activation.panel_opened', ts: now - (1 * 24 * 60 * 60 * 1000), payload: {} },
                { name: 'activation.panel_opened', ts: now - (5 * 24 * 60 * 60 * 1000), payload: {} },
            ];
