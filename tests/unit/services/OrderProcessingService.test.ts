...
describe('OrderProcessingService', () => {
    ...
    describe('acceptRequest', () => {
        it('deve aceitar pedido com sucesso', async () => {
            ...
            const result = await OrderProcessingService.acceptRequest(mockRequestId, mockRestaurantId);
        ...
        it('deve lançar erro quando pedido não é encontrado', async () => {
            ...
            await expect(
                OrderProcessingService.acceptRequest(mockRequestId, mockRestaurantId)
