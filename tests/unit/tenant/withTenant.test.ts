...
import { isDebugMode } from "../../../merchant-portal/src/core/debugMode";
import {
  assertTenant,
...
jest.mock("../../../merchant-portal/src/core/debugMode", () => ({
  isDebugMode: jest.fn(() => false),
}));

const mockedIsDebugMode = jest.mocked(isDebugMode);
...
describe("withTenant", () => {
  ...
  it("should throw error in debug mode when tenantId is null", () => {
    mockedIsDebugMode.mockReturnValueOnce(true);
    const mockQuery = {
      eq: jest.fn().mockReturnThis(),
    };
  ...
  it("should add impossible filter when tenantId is null outside debug mode", () => {
    mockedIsDebugMode.mockReturnValueOnce(false);
    const mockQuery = {
      eq: jest.fn().mockReturnThis(),
    };
...
describe("withTenantInsert", () => {
  ...
  it("should return empty array when tenantId is null outside debug mode", () => {
    mockedIsDebugMode.mockReturnValueOnce(false);
    const data = { name: "Test" };
