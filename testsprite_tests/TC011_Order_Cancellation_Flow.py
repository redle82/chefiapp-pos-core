...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Já tenho conta' to login.
        ...
        try:
            ...
            raise AssertionError("Test case failed: The order cancellation process did not complete as expected. The order state is not 'CANCELED', the cancellation event was not recorded, or further updates were not properly rejected as per the test plan.")
