                ...
                <div className="glass-card max-w-5xl mx-auto p-10 relative overflow-hidden">
                    ...
                    <div className="relative z-10 grid md:grid-cols-2 gap-10">
                        <div className="space-y-4">
                            <h3 className="text-2xl font-bold">Modelo tradicional de software para restauração</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-2xl font-bold text-primary">ChefIApp — sistema operacional direto</h3>
                            <ul className="space-y-3 text-muted">
                    ...
                    <div className="relative z-10 mt-10 text-center space-y-3">
                        ...
                        <p className="text-muted">
                            Menu web, TPV e operação não são produtos separados. No ChefIApp, eles nascem juntos.
                            O mesmo sistema que cria o menu público ativa o TPV e organiza a operação interna. Um fluxo. Não três contratos.
                        </p>
                        <p className="text-muted/80 text-sm md:text-base">
                            Se configurar um sistema exige horas de chamadas, o problema não é você. É o sistema.
                        </p>
                    </div>
                </div>
            </div>
