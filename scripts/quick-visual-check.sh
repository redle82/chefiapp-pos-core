...
if [ -n "$RESTAURANT_ID" ]; then
    ...
    echo "   TPV:      http://localhost:5175/app/tpv"
    echo "   Dashboard: http://localhost:5175/app/dashboard"
    echo "   KDS:      http://localhost:5175/app/kds/$RESTAURANT_ID"
else
    echo "5. URLs para testar:"
    echo "   TPV:      http://localhost:5175/app/tpv"
    echo "   Dashboard: http://localhost:5175/app/dashboard"
    echo "   KDS:      http://localhost:5175/app/kds/{restaurantId}"
