...
// Por defeito: dev local (evita 404 se app.chefiapp.com não estiver em produção).
// Para produção: APP_STAFF_URL=https://app.chefiapp.com/app/staff/home
// Para iPhone na mesma rede: APP_STAFF_URL=http://TEU_IP:5175/app/staff/home (ex.: 192.168.1.10)
const defaultUrl = "http://localhost:5175/app/staff/home";
...
console.log("No iOS: Câmara ou Safari → apontar ao QR → «Adicionar ao Ecrã Inicial» para PWA.");
if (url.includes("localhost")) {
  console.log("");
  console.log("Nota: localhost só funciona neste PC. Para iPhone/iPad na mesma rede, gera de novo com:");
  console.log("  APP_STAFF_URL=http://TEU_IP:5175/app/staff/home pnpm run qr:appstaff-ios");
