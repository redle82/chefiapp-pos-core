#!/bin/bash
# ============================================================================
# ABRIR PÁGINA DE MESA (QR CODE) — Script Docker-Only
# ============================================================================
# 
# OBJETIVO: Abrir página de mesa via QR code, assumindo Docker Core ativo
# 
# PRÉ-REQUISITOS:
...
#   Exemplo: ./scripts/open-qr-mesa.sh la-trattoria 5
# 
# ============================================================================
...
# ============================================================================
# 3. ABRIR PÁGINA DE MESA
# ============================================================================
echo "📱 Abrindo Página de Mesa (QR Code)..."
echo "   Slug: ${SLUG}"
echo "   Mesa: ${MESA}"
echo "   URL: ${BASE_URL}/public/${SLUG}/mesa/${MESA}"
echo ""

# Abrir no navegador
if command -v open &> /dev/null; then
    # macOS
    open "${BASE_URL}/public/${SLUG}/mesa/${MESA}"
elif command -v xdg-open &> /dev/null; then
    # Linux
    xdg-open "${BASE_URL}/public/${SLUG}/mesa/${MESA}"
elif command -v start &> /dev/null; then
    # Windows
    start "${BASE_URL}/public/${SLUG}/mesa/${MESA}"
else
    echo "❌ Não foi possível abrir o navegador automaticamente."
    echo "   Abra manualmente: ${BASE_URL}/public/${SLUG}/mesa/${MESA}"
fi
