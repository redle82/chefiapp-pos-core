...
echo -e "${GREEN}   Dashboard: http://localhost:5175/app/dashboard${NC}"
echo -e "${GREEN}   TPV:       http://localhost:5175/app/tpv${NC}"
echo -e "${GREEN}   KDS:       http://localhost:5175/app/kds/${RESTAURANT_ID}${NC}"
echo ""
