...
| **[GUIA_VALIDACAO_RUNTIME.md](GUIA_VALIDACAO_RUNTIME.md)**                                                 | Critérios de validação do runtime (demo vs real).                                                                                                                                                                                                          |
...
| **[MODO_DEMO_EXPLICATIVO_SPEC.md](MODO_DEMO_EXPLICATIVO_SPEC.md)**                                         | Modo Demo Explicativo: System Tree como modo de leitura (não tela principal); copy por seção; onde some/reaparece.                                                                                                                                         |
...
| Demo rápida (5 min) — System Tree, Dashboard, TPV v2, Tasks | **[DEMO_SCRIPT_5MIN.md](DEMO_SCRIPT_5MIN.md)**         |
| Demo completa (30 min) — Menu Builder, KDS, Tasks, Estoque  | **[DEMO_SCRIPT_V1.md](DEMO_SCRIPT_V1.md)**             |
...
- **Uso e demo:** README na raiz + DEMO_SCRIPT e TROUBLESHOOTING conforme necessário.
