...
**Vender ChefIApp v1 para 3-5 restaurantes até 20 de março.**

Não é sobre volume. É sobre **validação real** com early adopters.
...
- Problemas operacionais conhecidos:
  ...
  - Falta de visibilidade na cozinha
...
4. **Visita direta**
   - Ir em restaurantes médios
   - Falar com dono/gerente
   - Oferecer demo rápida (15 min)

**Meta:** Listar 10-15 restaurantes potenciais
...
```
Assunto: Sistema que reduz atrasos e desperdício em restaurantes

Olá [Nome],

Sou [Seu Nome], criador do ChefIApp — sistema operacional de produção para restaurantes.

Diferente de Toast ou Square, que focam em gestão, nós focamos em produção.

O sistema detecta atrasos automaticamente antes que virem problema. O estoque se conecta à operação e gera lista de compras automática. O menu define comportamento do sistema (tempo + estação).

Resultado: menos atrasos, menos desperdício, mais eficiência.

Quer ver uma demo de 30 minutos? Sem compromisso.
...
Quer ver uma demo rápida de 30 minutos? Sem compromisso.

[Seu Nome]
```

**Visita Direta (Script):**

```
"Olá, sou [Nome]. Tenho um sistema que ajuda restaurantes a reduzir atrasos e desperdício. É focado em produção — detecta atrasos automaticamente, conecta estoque à operação. Quer ver uma demo rápida de 15 minutos? Sem compromisso."
```

**Meta:** Agendar 5-8 demos

---

### FASE 2: Demo (Semana 2-3)
...
4. Agendar onboarding (1-2 semanas)
...
- "Preciso pensar" → Follow-up em 3 dias

**Meta:** Fechar 3-5 restaurantes

---

### FASE 4: Onboarding (Semana 4-6)
...
- **Não adicionar features** (guardar para v2)
...
**Razão:** Onboarding completo = sucesso garantido.
...
> **"Venda controlada = validação real, não volume."**

Não é sobre vender para muitos. É sobre validar com poucos e bem.

3-5 restaurantes bem atendidos > 20 restaurantes mal atendidos.

---

**Conclusão:** Roteiro comercial real pronto. Processo claro, objetivo claro, métricas claras. Pronto para começar a vender.
