...
| Documento                                                                                    | Propósito                                                                                                 |
| -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| [architecture/CHEFIAPP_OS_ARCHITECTURE_V1.md](./architecture/CHEFIAPP_OS_ARCHITECTURE_V1.md) | Manifesto técnico canónico do modelo Restaurant Operating System (Identity → Runtime → Context → Surface) |
...
| **10** | Architecture (Arquitetura Real)   | ARCHITECTURE*OVERVIEW.md, BOUNDARY_CONTEXTS.md, OFFLINE_STRATEGY.md, EDGE_CASES.md, C4*\*.md; MULTI_TENANT_ARCHITECTURE.md (✅) | 🟡 (✅ multi-tenancy) |
...
| 10 Architecture | 🟡 (✅ multi-tenancy) | ARCHITECTURE*OVERVIEW, BOUNDARY_CONTEXTS, OFFLINE_STRATEGY, EDGE_CASES, C4*\* criados                                         |
