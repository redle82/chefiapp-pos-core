...
Preencher 10 restaurantes/contactos candidatos ao piloto.
...
| # | Restaurante / contacto | Data prevista | Estado (a confirmar / confirmada / feita) |
|---|------------------------|---------------|------------------------------------------|
| 1 |                       |               |                                          |
| 2 |                       |               |                                          |
| 3 |                       |               |                                          |
...
*Preencher este doc e marcar os itens 5–9 no [ONDA_4_PILOTO_E_PRODUCAO_CHECKLIST.md](../ONDA_4_PILOTO_E_PRODUCAO_CHECKLIST.md) à medida que forem concluídos.*
