...
**Já temos feito:** Dashboard modo venda, Landing, Trial Guide, TPV mínimo, KDS mínimo, AppStaff mínimo, PWA (manifest + standalone), Billing webhook → live, Config (identidade, localização, horários) em modo Docker, narrativa “sistema operacional”.
...
| **Trial Guide**      | ✅     | Guia em `/trial-guide` — “Ver como funciona”                            |
| **Dashboard**        | ✅     | Modo venda, módulos TPV / KDS / AppStaff / Cardápio visíveis            |
| **TPV**              | ✅     | TPVMinimal em `/tpv`, ModeGate (trial/piloto/live), dockerCoreClient    |
...
| **Modos**            | ✅     | trial / piloto / live; aviso “Modo piloto” no TPV                       |
...
| 5   | **Menu de exemplo no trial** — Opção “Usar menu de exemplo” no onboarding para restaurante conseguir fazer primeira venda sem criar produtos à mão.                                                                                                | Alta       | 2–3 dias    |
...
| #   | Tarefa                                                                                                                                                                                                                              | Prioridade | Esforço   |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | --------- |
| 7   | **Remover / esconder modo “trial” em produção** — Em build de produção, não mostrar ModeIndicator nem permitir trocar para trial; ou mostrar só “Trial” como link separado (ex.: “Ver trial” na Landing), não dentro do app logado. | Alta       | 0.5–1 dia |
...
- Itens 7, 8, 9 (trial só onde fizer sentido, mensagens de ativação, erros em PT).
...
- **Sem** necessidade de explicar “modo trial” ou “backend Docker” ao cliente.
...
- [MODO_TRIAL_EXPLICATIVO_SPEC.md](MODO_TRIAL_EXPLICATIVO_SPEC.md) — Trial Guide e “como tudo se conecta”.
