...
## 11. Validação de docs e lineage
...
| **audit-contracts-referenced.sh** | Verifica documentos canónicos (CORE_*, BOOTSTRAP_*, etc.) e ficheiros .md vazios em docs/ e raiz; CORE_CONTRACT_INDEX vs disco. |
...
*Documento vivo. Novos runbooks em docs/ops devem ser indexados aqui.*
