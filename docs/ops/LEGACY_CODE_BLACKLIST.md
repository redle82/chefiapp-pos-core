...
| Guard ou middleware que redireccione para `/` ou `/landing` com base em "trial", "first-sale" ou "pilot" sem respeitar OPERATIONAL_OS | TRIAL_MODE não controla navegação em OPERATIONAL_OS                           | OPERATIONAL_NAVIGATION_SOVEREIGNTY |
...
_Lista preenchida após refactor pós-freeze (FASE 1)._
