...
| Documento | Conteúdo |
|------------|----------|
| [implementation/ROUTES_WEB_VS_OPERATION.md](implementation/ROUTES_WEB_VS_OPERATION.md) | Mapa canónico: WEB vs OPERAÇÃO; guard; nunca return null na web; /demo e /demo-guiado. |
...
| [DECLARACAO_POS_REFATORACAO_WEB_V1.md](DECLARACAO_POS_REFATORACAO_WEB_V1.md) | Declaração oficial pós-refatoração (v1 congelada): eliminado DEMO/perfis Gerente/Staff na web; estado canónico; Opção A /demo-guiado. |
...
| Documento | Conteúdo |
|-----------|----------|
| [implementation/INDEX.md](implementation/INDEX.md) | Índice das checklists de implementação (FASE 1–5), ROUTES_WEB_VS_OPERATION, web-config, routes, FASE_5_*. |
...
| [web-config/INDEX_WEB_CONFIG.md](web-config/INDEX_WEB_CONFIG.md) | Índice alternativo das rotas web (ROTA_*.md em web-config/). |
...
- **Sem demo conceitual:** Trial é real; não criar perfis Dono/Gerente/Staff na web como muletas; não reintroduzir Demo na lógica de produto.
