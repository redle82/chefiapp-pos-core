...
| [TERMINAL_INSTALLATION_RITUAL.md](../contracts/TERMINAL_INSTALLATION_RITUAL.md) | Ritual de instalação em /app/install; terminal como objeto vivo (nome + Online/Offline); fontes gm_equipment, installedDeviceStorage, gm_terminals. |
