...
A pergunta correcta não é *"Para onde este botão vai?"* mas *"Que estado do sistema este botão activa?"*
...
| **Contratos envolvidos** | [DEMO_MODE_CONTRACT.md](./DEMO_MODE_CONTRACT.md); [GLOBAL_UI_STATE_MAP.md](../product/GLOBAL_UI_STATE_MAP.md) (isDemo) |
...
- [DEMO_MODE_CONTRACT.md](./DEMO_MODE_CONTRACT.md) — modo Demo: nunca Core, nunca restaurante, nunca piloto
