...
- **FASE 5 — Polimento VPC/OUC (código):** Tokens VPC centralizados (`vpcTokens.ts`); `#111` → `#0a0a0a` (bg) e `#171717` → `#141414` (surface) em todas as vistas operacionais (KDS, TPV, ShiftGate, Tasks, Billing, Onboarding, CartDrawer, OrderSummaryPanel, ModulesPage, OrderStatusPanel); font-family normalizado para Inter em DashboardLayout e BillingPage. Typecheck limpo.
