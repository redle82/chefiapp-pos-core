...
| **Congela** | Billing, onboarding, Now Engine, gamificação, impressão — sem ERP, sem OS completo como *produto* | Quem manda, quem obedece, leis invisíveis (falha, tempo, verdade, silêncio) |
...
- **Status:** Adiado indefinidamente
- **Quando considerar:** Após produto estar vendendo bem
- **Não significa:** Proibir contratos, Kernel ou terminais (já existem e são lei). Significa: não *expor* tudo como produto/marketing "OS completo" agora — Toast, Lightspeed, ServiceNow tinham arquitetura de OS anos antes de a vender como tal.
