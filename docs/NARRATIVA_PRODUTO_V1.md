...
> **"Narrativa simples = problema claro + solução clara + valor claro."**

Não vendemos features. Vendemos **sistema operacional de produção**.

---

## 📝 Narrativa Principal (1 frase)

**"Sistema operacional de produção para restaurantes que conecta menu, cozinha, estoque e operação em tempo real."**
...
**Valor:** KDS mostra tempo real, Task Engine detecta atrasos, cliente vê status preciso.
...
**Valor:** Sistema detecta problemas antes que virem crise. Tarefas se fecham sozinhas.
...
**Valor:** Reduz desperdício, evita ruptura, otimiza compras.
...
**👉 Não competimos por features. Competimos por arquitetura.**
...
- KDS (2min)
- Task Engine (1min)
- Estoque + Lista de Compras (30s)
- Fechamento (30s)

**Uso:** Site, email, LinkedIn
...
- [ ] Validar narrativa com early adopters
